...
<div class="container" style="width: 35%;">
	<form method="post" action="<?php echo base_url('loginCreate');?>" class="p-sm-5 mx-auto mt-sm-5 rounded" method="post" style="border: 1px solid grey; box-shadow: 0 3px 7px 0 rgba(0,0,0,.35);">
